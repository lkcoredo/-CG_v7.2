...
public class animalEnemyAI : MonoBehaviour
{
    [Header("References")]
    ...
    private void Awake()
    {
        ...
        charactermotor = playerTransform.GetComponent<CharacterMotor>();
    ...
    void Update()
    {
        ...
        mHealthText.text = currentHealth.ToString();
        if(Vector3.Distance(player.position, transform.position) < detectionRadius && !charactermotor.isDead)
        {
    ...
    IEnumerator AttackPlayer()
    {
        ...
        playerInventory.TakeDamage(damageDealt);
